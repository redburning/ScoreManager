package scoremanager.common.dao.impl;
...
public class BaseDaoImpl implements BaseDao {
	...
	public <T> void saveOrUpdate(T entity) {
		try {
			...
			logger.error("Save or update entity exception: {}", e);
		}
	}
	...
	public <T> void save(T entity) {
		try {
			...
			logger.error("Save entity exception: {}", e);
		}
	}
	...
	public <T> void update(T entity) {
		try {
			...
			logger.error("Update entity exception: {}", e);
		}
	}
	...
	public <T> void delete(T entity) {
		try {
			...
			logger.error("Delete entity exception: {}", e);
		}
	}
